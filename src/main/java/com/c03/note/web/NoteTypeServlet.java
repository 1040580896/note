...
import com.c03.note.service.impl.NoteTypeServiceImpl;
import com.c03.note.util.JsonUtil;
import com.c03.note.vo.ResultInfo;
import com.c03.note.service.NoteTypeService;
...
public class NoteTypeServlet extends HttpServlet {
    ...
    private NoteTypeService typeService = new NoteTypeServiceImpl();
